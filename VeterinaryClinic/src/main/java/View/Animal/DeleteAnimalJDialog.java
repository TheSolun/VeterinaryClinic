...
public class DeleteAnimalJDialog extends javax.swing.JDialog {
    ...
    public DeleteAnimalJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelDeleteExamTittle.setText("Delete Animal");
        jPanelDeleteExamTittle.add(jLabelDeleteExamTittle, java.awt.BorderLayout.CENTER);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Are you sure that you want to delete the animal 'Foguinho'?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteAnimalJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DeleteAnimalJDialog dialog = new DeleteAnimalJDialog(new javax.swing.JFrame(), true);
