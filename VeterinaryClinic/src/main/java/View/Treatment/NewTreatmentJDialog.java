...
public class NewTreatmentJDialog extends javax.swing.JDialog {
    ...
    public NewTreatmentJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextFieldEditTreatmentStartDate.setText("");
        ...
        jTextFieldEditTreatmentEndDate.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewTreatmentJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewTreatmentJDialog dialog = new NewTreatmentJDialog(new javax.swing.JFrame(), true);
