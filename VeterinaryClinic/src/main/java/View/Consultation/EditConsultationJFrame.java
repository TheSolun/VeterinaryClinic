 ...
 * @author mateu
 */
public class EditConsultationJFrame extends javax.swing.JFrame {

    /** Creates new form EditConsultationJFrame */
    public EditConsultationJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditConsultationJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditConsultationJFrame().setVisible(true);
            }
        });
    }
