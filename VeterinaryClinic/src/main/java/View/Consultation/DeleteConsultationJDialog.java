...
public class DeleteConsultationJDialog extends javax.swing.JDialog {
    ...
    public DeleteConsultationJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteConsultationJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DeleteConsultationJDialog dialog = new DeleteConsultationJDialog(new javax.swing.JFrame(), true);
